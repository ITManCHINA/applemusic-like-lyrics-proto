...
export type { LrcAuxiliaryLineOptions, LrcAuxiliaryLinesOptions, LrcEndTimestampOptions, ParseLrcLikeOptions, StringifyLrcLikeOptions, } from './formats/lrc';
export { parseEslrc, parseLrc, parseLrcA2, parseLrcLike, parseSPL, stringifyEslrc, stringifyLrc, stringifyLrcA2, stringifyLrcLike, stringifySPL, } from './formats/lrc';
 ...
 */
export declare function stringifylrcA2(...args: Parameters<typeof stringifyLrcA2>): ReturnType<typeof stringifyLrcA2>;
export type { LyricLine, LyricParseResult, LyricWord, TTMLLyric, } from './types';
