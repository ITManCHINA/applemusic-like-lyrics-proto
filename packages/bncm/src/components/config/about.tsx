	...
	return (
		<div className="amll-about">
			<div>
				...
				<div className="amll-name">{manifest.name}</div>
				...
				<div className="author">By {manifest.author}</div>
				<div className="ext-links">
					<Button
						onClick={() => {
							betterncm.ncm.openUrl(
								"https://github.com/ITManCHINA/applemusic-like-lyrics-proto",
							);
						}}
					>
						访问 Github 仓库
					...
					<Button
						onClick={() => {
							betterncm.ncm.openUrl(
								"https://github.com/ITManCHINA/applemusic-like-lyrics-proto/issues/new",
							);
						}}
					>
						编写 Issue 提交 BUG
	...
	return (
		<div className="amll-about">
			<div>
				...
				<div className="amll-name">{manifest.name} 歌词播放器</div>
				<div className="version">
					{manifest.version} ({manifest.branch} - {manifest.commit.slice(0, 8)})
				</div>
				<div className="author">By {manifest.author}</div>
	...
	return (
		<div className="amll-about">
			<div>
				...
				<div className="amll-name">{manifest.name} 组件</div>
				<div className="version">
					{manifest.version} ({manifest.branch} - {manifest.commit.slice(0, 8)})
				</div>
				<div className="author">By {manifest.author}</div>
